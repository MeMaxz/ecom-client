...
import logo_hero from "@/assets/login_hero.png";
...
const validateForm = computed(() => {
  return email.value.includes("@") && password.value !== "";
});
  ...
  <UserLayout>
      <section class="flex justify-center items-center my-screen">
        <div class="card card-side bg-base-100 shadow-xl">
          ...
          <div class="flex flex-col items-center justify-center mx-20 my-5">
            <h1 class="text-8xl font-shrikhand stroke-custom-head">Welcome</h1>
            <h1 class="text-xl font-itim -mt-2">
              Please log in to your account.
            </h1>
            <form @submit.prevent="submitForm" class="w-full px-10">
              <!-- Email Input -->
              <div class="form-control w-full relative">
                <label class="font-itim font-bold m-2">Email Address</label>
                <input
                  type="email"
              ...
              <!-- Password Input -->
              <div class="form-control w-full relative">
                <label class="font-itim font-bold m-2">Password</label>
                ...
                <label class="label cursor-pointer justify-normal gap-2 mt-1">
                  <input
                    type="checkbox"
                    :checked="false"
                    class="checkbox checkbox-sm"
                  />
                  <span class="label-text font-itim">Remember me</span>
                </label>
              </div>
              <!-- Sign In Button -->
            ...
            <label class="w-full font-itim px-10"
              >If you don't have an account, click to
              <RouterLink :to="{ name: 'register' }"
                ><span class="my-register">Register</span> ?</RouterLink
              ></label
            >
          </div>
        </div>
